...
public struct Issue : IFlatbufferObject
{
  ...
  public BocchiTracker.ProcessLinkQuery.Queries.Vec3? Location { get { int o = __p.__offset(14); return o != 0 ? (BocchiTracker.ProcessLinkQuery.Queries.Vec3?)(new BocchiTracker.ProcessLinkQuery.Queries.Vec3()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  ...
  public static void AddLocation(FlatBufferBuilder builder, Offset<BocchiTracker.ProcessLinkQuery.Queries.Vec3> locationOffset) { builder.AddStruct(5, locationOffset.Value, 0); }
...
static public class IssueVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*Location*/, 12 /*BocchiTracker.ProcessLinkQuery.Queries.Vec3*/, 4, false)
