...
{
    ClassDB::bind_method(D_METHOD("create_player_position", "player_position", "stage"), &BocchiAPI::createPlayerPosition);
    ClassDB::bind_method(D_METHOD("create_application_basic_information", "pid", "app_name", "args", "platform"), &BocchiAPI::createApplicationBasicInformation);

    BIND_ENUM_CONSTANT(BocchiTracker::ProcessLinkQuery::Queries::QueryID_NONE)
    BIND_ENUM_CONSTANT(BocchiTracker::ProcessLinkQuery::Queries::QueryID_AppBasicInfo)
    BIND_ENUM_CONSTANT(BocchiTracker::ProcessLinkQuery::Queries::QueryID_PlayerPosition)
    BIND_ENUM_CONSTANT(BocchiTracker::ProcessLinkQuery::Queries::QueryID_ScreenshotData)
    BIND_ENUM_CONSTANT(BocchiTracker::ProcessLinkQuery::Queries::QueryID_ScreenshotRequest)
    BIND_ENUM_CONSTANT(BocchiTracker::ProcessLinkQuery::Queries::QueryID_JumpRequest)
    BIND_ENUM_CONSTANT(BocchiTracker::ProcessLinkQuery::Queries::QueryID_IssueesRequest)
}
